...
void HAL_CleanAnalogTrigger(HAL_AnalogTriggerHandle analogTriggerHandle,
 ...
 static double GetAnalogValueToVoltage(HAL_AnalogTriggerHandle analogTriggerHandle, int32_t value, int32_t* status) {
...
void HAL_SetAnalogTriggerLimitsRaw(HAL_AnalogTriggerHandle analogTriggerHandle,
  ...
  double trigLower = GetAnalogValueToVoltage(trigger->analogHandle, lower, status);
  if (status != 0) return;
  double trigUpper = GetAnalogValueToVoltage(trigger->analogHandle, upper, status);
  if (status != 0) return;
...
void HAL_SetAnalogTriggerAveraged(HAL_AnalogTriggerHandle analogTriggerHandle,
  ...
  auto setVal = useAveragedValue ? HALSIM_AnalogTriggerAveraged : HALSIM_AnalogTriggerUnassigned;
...
void HAL_SetAnalogTriggerFiltered(HAL_AnalogTriggerHandle analogTriggerHandle,
  ...
  auto setVal = useFilteredValue ? HALSIM_AnalogTriggerAveraged : HALSIM_AnalogTriggerUnassigned;
  triggerData->SetTriggerMode(setVal);
}
