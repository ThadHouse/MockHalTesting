...
class NotifyListenerVector {
 ...
 public:
  ...
  NotifyListenerVector(void* param, HAL_NotifyCallback callback, unsigned int* newUid);
  ...
  // Add a new NotifyListener to a copy of the vector.  If there are elements on the freelist,
